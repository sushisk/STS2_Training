...
class SelectionAudit:
    ...
    def remember(
        ...
        *,
        ...
        """Remember a Decision; the legacy ordinal-mode hint is intentionally ignored."""
        _ = wire_commit_action_id_is_ordinal
    ...
    def record_action(
        ...
        *,
        ...
        selected_action_id = _selected_public_action_id(received, event_request)
        ...
        event: dict[str, Any] = {
            ...
            # DTO v0.7 action_id is opaque and is sent unchanged. Keep an explicit
            # selected_action_id label so self-play consumers do not need to infer it
...
def _selected_public_action_id(
    ...
    """Return the opaque public action_id selected from the received Decision."""
