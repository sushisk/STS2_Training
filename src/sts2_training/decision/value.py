...
between ranking and value code. A learned value model can still override batched
inference directly.
"""
...
class ValueModel:
    ...
    Implement `evaluate` for scalar inference, or override `evaluate_batch` directly for
    a batch-only learned model.
    """
