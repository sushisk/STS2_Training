...
Repo-local supplement to [dto_v07_paired_release_assurance.md](dto_v07_paired_release_assurance.md), which is a canonical file synced byte-identical with STS2_RL's copy. **This file is NOT synced** — STS2_RL maintains its own version of this file describing its own CI.
