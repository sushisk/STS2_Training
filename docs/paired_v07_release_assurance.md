...
The exact required job name, workflow file, and what it validates are repo-local facts, not part of this shared contract - see this repository's own `paired_v07_release_assurance_local.md` (not synced across repositories).
